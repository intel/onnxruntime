...
#if OPENVINO_VERSION_MAJOR == 2026 && OPENVINO_VERSION_MINOR == 4
  data_ops_ = std::make_unique<DataOps>(graph_viewer_, V_2026_4, device_type_, npu_qdq_optimizer_enabled);
#elif OPENVINO_VERSION_MAJOR == 2026 && OPENVINO_VERSION_MINOR == 3
  data_ops_ = std::make_unique<DataOps>(graph_viewer_, V_2026_3, device_type_, npu_qdq_optimizer_enabled);
#elif OPENVINO_VERSION_MAJOR == 2026 && OPENVINO_VERSION_MINOR == 2
