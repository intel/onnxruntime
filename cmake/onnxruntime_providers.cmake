...
if (onnxruntime_USE_OPENVINO_BINARY)
  ...
  if ($ENV{INTEL_CVSDK_DIR} MATCHES "2019.3")
   if (WIN32)
     ...
     target_link_libraries(onnxruntime_providers_openvino $ENV{INTEL_CVSDK_DIR}/deployment_tools/inference_engine/lib/intel64/Release/inference_engine.lib IE::ie_cpu_extension)
     ...
     target_link_libraries(onnxruntime_providers_openvino PUBLIC -linference_engine IE::ie_cpu_extension -ltbb ${PYTHON_LIBRARIES})
