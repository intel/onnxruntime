...
if (onnxruntime_USE_OPENVINO_BINARY)
  ...
  if ($ENV{INTEL_CVSDK_DIR} MATCHES "2019.3")
   if (WIN32)   
     ...
     link_directories(onnxruntime_providers_openvino -linference_engine ${PYTHON_LIBRARIES} ${OPENVINO_LIB_DIR} ${OPENVINO_TBB_DIR} ${OPENVINO_MKL_TINY_DIR} ${PYTHONPATH} ${OPENVINO_CPU_EXTENSION_DIR})
     target_link_libraries(onnxruntime_providers_openvino $ENV{INTEL_CVSDK_DIR}/deployment_tools/inference_engine/lib/intel64/Release/inference_engine.lib -lcpu_extension)
     file(COPY ${onnxruntime_providers_openvino_py_srcs} DESTINATION ${onnxruntime_BINARY_DIR}/${CMAKE_BUILD_TYPE})
   else()
     link_directories(onnxruntime_providers_openvino ${OPENVINO_LIB_DIR} ${OPENVINO_TBB_DIR} ${OPENVINO_MKL_TINY_DIR} ${OPENVINO_CPU_EXTENSION_DIR})
     target_link_libraries(onnxruntime_providers_openvino PUBLIC -linference_engine -lcpu_extension -ltbb ${PYTHON_LIBRARIES})
