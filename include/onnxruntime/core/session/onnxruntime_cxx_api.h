...
struct SessionOptionsImpl : ConstSessionOptionsImpl<T> {
  ...
  SessionOptionsImpl& AppendExecutionProvider_OpenVINO_V2(const OrtOpenVINOProviderOptionsV2& provider_options);  ///< Wraps OrtApi::SessionOptionsAppendExecutionProvider_OpenVINO
